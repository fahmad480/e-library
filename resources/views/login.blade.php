...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url("/css/themes/dark-layout.css") }}">
    </script>
    <link rel="stylesheet" type="text/css" href="{{ url("/css/themes/bordered-layout.css") }}">
    </script>
    <link rel="stylesheet" type="text/css" href="{{ url("/css/themes/semi-dark-layout.css") }}">
    </script>

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="{{ url("/css/core/menu/menu-types/vertical-menu.css") }}">
    </script>
    <link rel="stylesheet" type="text/css" href="{{ url("/css/plugins/forms/form-validation.css") }}">
    </script>
    <link rel="stylesheet" type="text/css" href="{{ url("/css/pages/authentication.css") }}">
    </script>
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click"
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid" src="{{ url("/images/pages/login-v2.svg") }}" alt="Login V2" />
                            </div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
    ...
    <script src="{{ url("/vendors/js/forms/validation/jquery.validate.min.js") }}"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ url("/js/scripts/pages/auth-login.js") }}"></script>
    <!-- END: Page JS-->
    ...
    <script>
        ...
        $(document).ready(() => {
            if ({{ session()->has('toastr_message') ? 'true' : 'false' }}) {
                toastr['{{ session('toastr_type', 'success') }}'](
                    '{{ session('toastr_message') }}',
                    '{{ session('toastr_title') }}', {
                        closeButton: true,
                        tapToDismiss: true
                    }
                )
